...
/// Fungsi rekursif untuk menambahkan data konsumen dan transaksi
void tambahkanDataRekursif(vector<Konsumen>& daftarKonsumen, vector<Transaksi>& daftarTransaksi) {
    // Tambahkan data konsumen dan transaksi
    ...
    cin >> lagi;
    if (lagi == 'y' || lagi == 'Y') {
        // Jika ingin menambahkan lagi, panggil fungsi rekursif lagi
        tambahkanDataRekursif(daftarKonsumen, daftarTransaksi);
    }
}
